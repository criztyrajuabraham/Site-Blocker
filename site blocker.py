...
Websites = Text(root, font='arial 12 bold', height='2', width='40')
...
block = Button(root, text='block', font="arial 12 bold", pady=5, command=Blocker, width=6, bg='aliceblue',
               activebackground='sky blue')
block.place(x=210, y=150)
root.mainloop()
